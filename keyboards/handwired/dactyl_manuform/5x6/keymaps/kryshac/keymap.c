 ...
 */
  ...
  [_RAISE] = LAYOUT_5x6(
       ...
       KC_MUTE,_______,KC_BRIU,KC_BRID,_______,KC_LCBR,                        KC_RCBR, KC_7  , KC_8  , KC_9  ,_______,_______,
       KC_VOLU,KC_LEFT,KC_UP  ,KC_DOWN,KC_RGHT,KC_LBRC,                        KC_RBRC, KC_4  , KC_5  , KC_6  ,_______,_______,
       KC_VOLD,KC_MPRV,KC_MPLY,KC_MNXT,_______,KC_LPRN,                        KC_RPRN, KC_1  , KC_2  , KC_3  ,_______,_______,
